...
%prep
%setup -q -n grpcio-channelz-1.41.1
cd %{_builddir}/grpcio-channelz-1.41.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635737088
...
cp %{_builddir}/grpcio-channelz-1.41.1/LICENSE %{buildroot}/usr/share/package-licenses/grpcio-channelz/2b8b815229aa8a61e483fb4ba0588b8b6c491890
